...
public class EntitySlimeT extends EntityMob {

    private static final DataParameter<Byte> ON_FIRE = EntityDataManager.<Byte>createKey(EntitySlimeT.class, DataSerializers.BYTE);

    public EntitySlimeT(World worldIn)
    {
        super(worldIn);
    ...
    public static void registerFixesSlimeT(DataFixer fixer)
    {
        EntityLiving.registerFixesMob(fixer, EntitySlimeT.class);
    }

    protected void initEntityAI()
    {
        this.tasks.addTask(4, new EntitySlimeT.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase
        {
            private final EntitySlimeT blaze;
            private int attackStep;
            private int attackTime;

            public AIFireballAttack(EntitySlimeT blazeIn)
            {
                this.blaze = blazeIn;
                this.setMutexBits(3);
            }
